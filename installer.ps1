...
try {
    ...
    Write-Warning "Gagal Disable Windows Defender Service"
}
...
try {
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender" -Name "DisableRoutinelyTakingAction" -Value 0 -PropertyType DWORD -Force -ea 0 | Out-Null
    ...
    New-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\MRT" -Name "DontReportInfectionInformation" -Value 1 -PropertyType DWORD -ea 0 | Out-Null
    ...
    Write-Warning "Gagal Disable Windows Defender"
}
